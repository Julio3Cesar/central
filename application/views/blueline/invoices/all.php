  ...
  <div class="col-sm-12  col-md-12 main">  
    <div class="row tile-row">
      <div class="col-md-4 col-xs-6 tile">
        ...
        <h1> 
          <?php if(isset($invoices_due_this_month)){echo $invoices_due_this_month;} ?> 
          <span class="hidden-xs"><?=$this->lang->line('application_invoices');?></span>
        </h1>
        <h2 class="hidden-xs">
          <?=$this->lang->line('application_due_this_month');?>
        </h2>
      </div>
      <div class="col-md-4 col-xs-6 tile"><div class="icon-frame secondary"><i class="ion-ios-analytics"></i> </div><h1> <?php if(isset($invoices_paid_this_month)){echo $invoices_paid_this_month;} ?> <span class="hidden-xs"><?=$this->lang->line('application_invoices');?></span></h1><h2 class="hidden-xs"><?=$this->lang->line('application_paid_this_month');?></h2></div>
      <div class="col-md-4 col-xs-6 tile">
        <div class="icon-frame">
          <i class="ion-ios-bell"></i> 
        </div>
        <h1>
          <span class="hidden-xs"><?php echo display_money($total, $value->currency); ?></span>
        </h1>
        <h2 class="hidden-xs">Total</h2>
      </div>
      <!-- <div class="col-md-3 col-xs-12 tile">
        <div style="width:97%; height: 93px;">
          <canvas id="tileChart" class="" width="auto" height="50"></canvas>
        </div>
      </div> -->
...
$labels = '"'.date("d-m",strtotime('monday this week')).'","'.
